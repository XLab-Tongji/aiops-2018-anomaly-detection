...
if __name__ == '__main__':
    ...
    file = 'service_data.csv'
    data = pd.read_csv(file)

    labels = [
        "carts:80 / container_fs_io_current",
        "carts: 80 / container_fs_usage_bytes",
        "catalogue: 80 / container_fs_io_current",
        "catalogue: 80 / container_fs_usage_bytes",
        "edge - router: 80 / container_fs_io_current",
        "edge - router: 80 / container_fs_usage_bytes",
        "orders: 80 / container_fs_io_current",
        "orders: 80 / container_fs_usage_bytes",
        "payment: 80 / container_fs_io_current",
        "payment: 80 / container_fs_usage_bytes",
        "shipping: 80 / container_fs_io_current",
        "shipping: 80 / container_fs_usage_bytes"
    ]
